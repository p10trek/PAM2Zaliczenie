...
namespace PAM2Zaliczenie.Controllers
{
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Login,Password")] PAM2Zaliczenie.Models.Users users)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Login,Password")] PAM2Zaliczenie.Models.Users users)
        {
            if (id != users.Id)
            {
                return NotFound();
